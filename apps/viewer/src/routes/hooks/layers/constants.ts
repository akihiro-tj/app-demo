...
export const LAND_TILE_SOURCE_URL = "/tiles/land.pmtiles";
export const MOUNTAIN_TILE_SOURCE_URL = "/tiles/mountain.pmtiles";
export const ISLAND_TILE_SOURCE_URL = "/tiles/island.pmtiles";
